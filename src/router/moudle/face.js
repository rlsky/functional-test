const Face = () =>
  import(/* webpackChunkName: "group-Face" */ 'views/face/index.vue')
const QianTaoOne = () =>
  import(/* webpackChunkName: "group-Face" */ 'views/face/compotent/qiantaoOne') // 路由懒加载
const QianTaoTwo = () =>
  import(/* webpackChunkName: "group-Face" */ 'views/face/compotent/qiantaoTwo')
